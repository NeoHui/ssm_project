...
public class MailUtil {
   ...
   public static void sendMsg(String to ,String subject ,String content) throws Exception{
      ...
      //4.设置消息的发送者
      Address fromAddr = new InternetAddress("1140471896@qq.com");
      ...
      //9.设置火箭的发射目标
      transport.connect("smtp.qq.com", "1140471896@qq.com", "aevgyntsjblsgbdg"); //密码 授权密码!=登陆密码
      //10.发送
   ...
   public static void main(String[] args) throws Exception {
      MailUtil.sendMsg("huixinwei@163.com" , "我们去玩把", "你好");
   }
