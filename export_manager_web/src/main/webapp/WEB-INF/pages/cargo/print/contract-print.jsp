    ...
    <div class="box box-primary" style="height: 200px;">
        ...
        <form role="form" action="/cargo/contract/printExcel.do">
            <div class="input-group input-group-sm" >
                ...
                <input type="text" name="inputDate" class="form-control pull-right" id="datepicker" placeholder="单击选择导出合同日期">
        ...
        <form role="form" action="/cargo/contract/printExcelWithTemplate.do">
            <div class="input-group input-group-sm" >
                ...
                <input type="text" name="inputDate" class="form-control pull-right" id="datepicker1" placeholder="单击选择导出合同日期">
                <span class="input-group-btn">
